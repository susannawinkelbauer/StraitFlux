...
setup(
    ...
    packages = ['StraitFlux'],
    version = '1.3.0',
    install_requires=['xarray', 'netcdf4', 'xesmf', 'xmip', 'tqdm', 'matplotlib', 'dask', 'gsw'], #external packages as dependencies
    ...
    download_url = 'https://github.com/susannawinkelbauer/StraitFlux/archive/refs/tags/v1.3.0.tar.gz',
